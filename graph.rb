# see image: https://s3.amazonaws.com/viking_education/web_development/web_app_eng/graph_social_network.jpg
visited = []
queue = [mooneye, mooneye, awws, inbread, eyes, paws ]
...
def find_human(search_type, head_node, search_input)
  ...
  step_counter = 0
  until search_input == current_node.name || queue == []
